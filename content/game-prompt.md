# AI Content Prompt - Arrow Cube Escape
...
## GENRE CONTEXT - SHOOTING

Use this knowledge to write accurate, specific content. Do NOT treat this as a generic game.

- **Core mechanics:** aim and fire at targets or enemies; bullet patterns, hitboxes, ammo management
- **Target audience:** gamers aged 13-40; fans of precision and skill expression
- **Key player benefits:** improves aim and focus, satisfying feedback, competitive
- **Playstyle:** focused and intense; rewards precision
- **Level structure:** wave-based or stage-based; boss fights at intervals
- **SEO angles to use:** free shooting game browser, online shooter no download, play shooting game free
- **Tip writing style:** aim for weak points, conserve ammo, strafe rather than standing still
...
- Name five real difficulty tiers or game-mode categories that fit Shooting games.
...

{
  ...
  "homepage": {
    ...
    "about": {
      "kicker": "What is Arrow Cube Escape?",
      "headline": "...",
      "paragraph1": "...",
      "paragraph2": "..."
    },
    ...
    "faq": [
      { "q": "What is Arrow Cube Escape?",             "a": "..." },
      { "q": "Is Arrow Cube Escape free?",             "a": "..." },
      { "q": "Does Arrow Cube Escape work on mobile?", "a": "..." },
      { "q": "How many levels are there?",  "a": "..." },
      { "q": "Is Arrow Cube Escape safe for kids?",    "a": "..." },
    ...
    "posts": [
      {
        ...
        "title": "Getting Started with Arrow Cube Escape: A Complete Beginner's Guide",
        "excerpt": "...",
        "category": "Guide",
        "readTime": "5 min read",
        "date": "2026-01-01",
        "icon": "🗺️",
        "sections": [
          { "heading": "What Is Arrow Cube Escape?",    "paragraphs": ["...", "..."] },
      ...
      },
      {
        ...
        "title": "Top Tips & Tricks for Arrow Cube Escape",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "7 min read",
        "date": "2026-01-05",
      ...
      {
        "slug": "game-benefits",
        "title": "The Cognitive Benefits of Playing Arrow Cube Escape",
        "excerpt": "...",
        "category": "Science",
        "readTime": "6 min read",
        "date": "2026-01-10",
      ...
      {
        "slug": "how-to-improve",
        "title": "How to Get Better at Arrow Cube Escape",
        "excerpt": "...",
        "category": "Strategy",
        "readTime": "8 min read",
        "date": "2026-01-15",
      ...
      {
        "slug": "parents-guide",
        "title": "Arrow Cube Escape for Kids: A Parent's Complete Guide",
        "excerpt": "...",
        "category": "Family",
        "readTime": "6 min read",
        "date": "2026-01-20",
        "icon": "👨‍👩‍👧",
        "sections": [
          { "heading": "Is Arrow Cube Escape Safe for Children?", "paragraphs": ["...", "..."] },
