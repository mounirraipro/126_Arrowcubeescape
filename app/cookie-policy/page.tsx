...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Arrow Cube Escape uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Arrow Cube Escape cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Arrow Cube Escape uses them, and how you can
                ...
                <p>Arrow Cube Escape uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Arrow Cube Escape.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@arrowcubeescape.com</strong>.
                </p>
            </div>
        </>
    );
