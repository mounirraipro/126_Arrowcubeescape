...
export const metadata: Metadata = {
    ...
    description: 'Read the Arrow Cube Escape Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Arrow Cube Escape terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Arrow Cube Escape. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Arrow Cube Escape at arrowcubeescape.com, you acknowledge that you have read,
                ...
                <p>
                    Arrow Cube Escape provides a free, browser-based game. Arrow Cube Escape is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Arrow Cube Escape is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Arrow Cube Escape — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Arrow Cube Escape or its
                ...
                <p>
                    ...
                    Arrow Cube Escape for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Arrow Cube Escape, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Arrow Cube Escape a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Arrow Cube Escape displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Arrow Cube Escape is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Arrow Cube Escape and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Arrow Cube Escape at our sole
                ...
                <p>
                    ...
                    <strong>legal@arrowcubeescape.com</strong>.
                </p>
            </div>
        </>
    );
