...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Arrow Cube Escape disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Arrow Cube Escape disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Arrow Cube Escape (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on arrowcubeescape.com
                ...
                <p>
                    Arrow Cube Escape is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Arrow Cube Escape displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Arrow Cube Escape.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Arrow Cube Escape is not responsible for any errors
