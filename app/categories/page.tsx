...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Arrow Cube Escape puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Arrow Cube Escape categories'],
  alternates: {
