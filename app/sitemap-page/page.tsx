...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Arrow Cube Escape. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Arrow Cube Escape sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Arrow Cube Escape' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Arrow Cube Escape?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Arrow Cube Escape.</p>
                </div>
            </div>
