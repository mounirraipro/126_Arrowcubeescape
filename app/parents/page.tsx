...
export const metadata: Metadata = {
    ...
    description: 'Arrow Cube Escape is a safe, educational, and family-friendly game. Learn how we protect children and promote healthy screen time.',
    keywords: ['Arrow Cube Escape for kids', 'safe game', 'children online safety', 'educational game', 'family friendly games'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Everything parents need to know about Arrow Cube Escape and online safety.</p>
                </div>
            </div>
            ...
            <div className="page-content">
                ...
                <p>
                    Arrow Cube Escape is a family-friendly game created to provide wholesome entertainment
                    for players of all ages. We understand that parents care deeply about what their children
                    do online, and we&apos;ve built Arrow Cube Escape with safety, education, and fun as our core priorities.
                </p>
                ...
                <p>
                    ...
                    children and adults alike. Here&apos;s what your child gains from playing Arrow Cube Escape:
                </p>
                <ul>
                ...
                <p>
                    Arrow Cube Escape does not collect any personal information from children. There are no
                ...
                <p>
                    Arrow Cube Escape is completely free to play with no hidden costs. There are no virtual
                ...
                <p>
                    All content used in Arrow Cube Escape is carefully curated to be appropriate for all ages.
                    All content in Arrow Cube Escape is carefully selected to be appropriate for all ages.
                </p>

                <h3>Advertisements</h3>
                <p>
                    Arrow Cube Escape displays advertisements to support the free service. These ads are served
                ...
                <p>
                    We take the Children&apos;s Online Privacy Protection Act (COPPA) seriously. Arrow Cube Escape
                ...
                <p>
                    While Arrow Cube Escape is designed to be safe, we encourage parents to take an active role
                ...
                <ol>
                    ...
                    <li><strong>Discuss online safety:</strong> Use Arrow Cube Escape as a starting point to talk about safe internet habits.</li>
                ...
                <h2>Have Concerns?</h2>
                <p>
                    If you have any questions or concerns about your child&apos;s experience on Arrow Cube Escape,
