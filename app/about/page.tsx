...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Arrow Cube Escape',
        url: 'https://arrowcubeescape.com/about',
        description: 'Learn about Arrow Cube Escape, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
...
export const metadata: Metadata = {
    title: 'About Us – Arrow Cube Escape',
    description: 'Learn about Arrow Cube Escape, our mission, and the team behind the game.',
    keywords: ['about Arrow Cube Escape', 'game team', 'who made Arrow Cube Escape'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Arrow Cube Escape</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Arrow Cube Escape was born from a simple idea: what if playing Arrow Cube Escape could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Arrow Cube Escape with a clear vision — to create a free, accessible, and
                    ...
                    Arrow Cube Escape has something for you.
                </p>
                ...
                <p>
                    Every level in Arrow Cube Escape is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Arrow Cube Escape offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Arrow Cube Escape better for
                    everyone.
                </p>
            </div>
        </>
