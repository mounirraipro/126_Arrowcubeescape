...
export const metadata: Metadata = {
    ...
    description: 'Read the Arrow Cube Escape Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Arrow Cube Escape privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Arrow Cube Escape, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Arrow Cube Escape, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Arrow Cube Escape is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@arrowcubeescape.com</strong>.
                </p>
            </div>
        </>
    );
