...
const SUPPORT_EMAIL = 'hello@arrowcubeescape.com';

export const metadata: Metadata = {
    title: 'Contact Arrow Cube Escape',
    description: 'Get in touch with the Arrow Cube Escape team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Arrow Cube Escape', 'Arrow Cube Escape support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
