...
const SITE_URL = 'https://arrowcubeescape.com';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Arrow Cube Escape',
        url: SITE_URL,
        description: 'Play Arrow Cube Escape free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Arrow Cube Escape online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
