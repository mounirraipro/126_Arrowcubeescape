...
const categorySeed: Array<Omit<GameCategory, 'levels'>> = [
  {
    ...
    longDescription: 'Arrowcubeescape beginner levels are designed for fast starts, clear goals, and casual sessions.',
  },
  {
    slug: 'classic',
    name: 'Classic',
    ...
    longDescription: 'Arrowcubeescape classic levels give players a balanced route through the core game experience.',
  },
  {
    slug: 'challenge',
    name: 'Challenge',
    ...
    longDescription: 'Arrowcubeescape challenge levels are built for players who enjoy tougher decisions and longer sessions.',
  },
  {
    slug: 'expert',
    name: 'Expert',
    ...
    longDescription: 'Arrowcubeescape expert levels collect the most demanding scenarios for experienced players.',
  },
];
