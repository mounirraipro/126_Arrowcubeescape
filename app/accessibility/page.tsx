...
export const metadata: Metadata = {
    ...
    description: 'Arrow Cube Escape is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Arrow Cube Escape accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Arrow Cube Escape accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Arrow Cube Escape is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Arrow Cube Escape presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Arrow Cube Escape. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@arrowcubeescape.com</strong></li>
                </ul>
                <p>
